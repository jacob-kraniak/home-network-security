...
**Phase 3 remote network access:** [docs/phases/phase-3-remote-access.md](docs/phases/phase-3-remote-access.md) — exit is laptop → datacenter off-LAN. RustDesk does not meet it. Issue [#34](https://github.com/jacob-kraniak/home-network-security/issues/34).
...
- Off-LAN network path to the rack in Phase 3 (VPN / WireGuard / Tailscale)
...
- **Do not treat RustDesk as Phase 3 remote access.** Phase 3 exit is a network path from the laptop off-LAN.
