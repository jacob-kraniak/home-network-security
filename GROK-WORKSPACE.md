...
- **Self-Hosted Services Research & Roadmap**: docs/roadmap/self-hosted-services-roadmap.md (Host OS, Proxmox, OPNsense, Wazuh, RustDesk, media servers, Home Assistant, camera migration, phased roadmap)
