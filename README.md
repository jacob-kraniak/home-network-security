...
**Start here for live state:** [docs/phases/phase-2-checkpoint-2026-09-05.md](docs/phases/phase-2-checkpoint-2026-09-05.md) (2026-09-05).  
**Wazuh outage narrative (historical):** [docs/phases/phase-2-baseline-2026-08-29.md](docs/phases/phase-2-baseline-2026-08-29.md).

This repository is **public**. Keep credentials, WAN IPs, full MACs, and unredacted scans out of commits. NetBox is authoritative for IPAM.
...
- Foundation for Wazuh + Portainer on the M715q; AdGuard / WireGuard next (not media until CT 101 disk and/or USB 3)

## Key Documents

- [Phase 2 checkpoint (2026-09-05)](docs/phases/phase-2-checkpoint-2026-09-05.md) — **return here first**
...
1. Clone the repo
2. Read [docs/phases/phase-2-checkpoint-2026-09-05.md](docs/phases/phase-2-checkpoint-2026-09-05.md) before changing the M715q
