# Hardware Decisions Log (Updated September 16, 2026)
...
- **Phase 2 guests (live 2026-09-16):** CT 100 Wazuh AIO (6 GiB / 81G); CT 101 Portainer (6 GiB / 100G) running Portainer + Omada 6.3 + RustDesk + NetBox v4.7. Details in [phase-2-checkpoint-2026-09-16.md](../phases/phase-2-checkpoint-2026-09-16.md).
...
- **Constraint updated 2026-09-16:** host ~14.6 GiB; CT split 6G Wazuh / 6G Portainer. NetBox added to CT 101 instead of a new CT 102 so all app containers stay in Portainer. Do not WAN-publish `:8000`.
