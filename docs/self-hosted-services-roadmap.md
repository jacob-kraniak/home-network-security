...
**Phase 1 (Q2 2026):** Base OS + Proxmox + OPNsense + Wazuh.
...
**Next Steps for Workspace:** Paste these blocks, expand issues in GitHub Project Board, and track decisions. Let me know which area to deep-dive or generate configs for next. This keeps everything documented, privacy-aligned, and actionable per your guidelines.