...
- [infrastructure-criteria.md](../hardware/infrastructure-criteria.md) — Server hardware decisions and revised core infrastructure strategy (Omada buildout: **ER605 V2**, SG2008P v3.20, EAP225).
...
- [ROADMAP.md](../ROADMAP.md) — High-level project roadmap (Phase 1 complete: EAP225, SG2008P v3.20, **ER605 V2**).
- Main project: [README.md](../../README.md) and [GROK-WORKSPACE.md](../../GROK-WORKSPACE.md)

**Note**: Living documents. Gateway in diagrams and prose is **ER605 V2** only.
