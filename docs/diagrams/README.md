...
- [infrastructure-criteria.md](../hardware/infrastructure-criteria.md)
- ... 
- [home-lab-rack-build.md](../hardware/home-lab-rack-build.md) — Confirmed dual rack measurements.

**Note**: Living documents. **Updated June 6, 2026 with confirmed rack measurements.** Open diagrams in draw.io to adjust physical scales, add second rack representation, and reallocate gear.